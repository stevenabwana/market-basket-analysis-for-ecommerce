...
if(isset($_POST["page"])){
	...
	for($i=1;$i<=$pageno;$i++){
		echo "
			<li><a href='#' page='Kshs.i' id='page'>$i</a></li>
		";
	}
}
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="ispace_store@aol.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/ecm/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/ecm/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/ecm/cancel.php"/>
